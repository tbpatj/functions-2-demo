...
// CODE HERE
const totalPopulation  = populations.reduce( (accu,curElement) => accu + curElement)
...
// CODE HERE
const myStrongest  = monstersInYourPocket.filter( (element,index) => element.CP > 200)
...
/*
  ...
  after adding in the sales tax (given to you as a tax rate,
...
let priceArray = orders.map( (element,index) => {
  return element.price * (element.tax + 1.0);
});
